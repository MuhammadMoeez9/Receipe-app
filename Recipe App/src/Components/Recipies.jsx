...
import UploadRecipeForm from "./UploadRecipeForm"; // Import the UploadRecipeForm component
...
const RecipeList = () => {
  ...
  useEffect(() => {
    setTimeout(() => {
      ...
      setLoading(false); // Set loading to false afterdata is fetched
    }, 2000);
  }, []);
  ...
  return (
    <div className="recipe-container">
      ...
      {/* Upload Recipe Form */}
      <UploadRecipeForm onRecipeUpload={handleRecipeUpload} />
          ...
          <div key={recipe.id} className="card" style={{ width: "18rem" }}>
            <Link to={`/recipe/${recipe.id}`}>
              ...
              <div className="card-body">
                ...
                <p className="card-title px-2">Instructions</p>
                <ol>
